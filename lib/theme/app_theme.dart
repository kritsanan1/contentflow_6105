...
class AppTheme {
  ...
  // Color specifications based on Adaptive Professional Spectrum
  ...
  // Accent gradient colors (reserved for primary CTA button)
  ...
  /// Gradient decoration for primary CTA button
  ...
  /// Glassmorphism decoration for special cards
  static BoxDecoration glassmorphismDecoration({required bool isLight}) {
    return BoxDecoration(
      color: (isLight ? Colors.white : Colors.black).withAlpha(26),
      borderRadius: BorderRadius.circular(12.0),
      border: Border.all(
        color: (isLight ? Colors.white : Colors.white).withAlpha(51),
        width: 1.0,
      ),
      boxShadow: [
        BoxShadow(
          color: (isLight ? Colors.black : Colors.black).withAlpha(26),
          blurRadius: 10.0,
  ...
  /// Neumorphism decoration for interactive elements
  static BoxDecoration neumorphismDecoration({required bool isLight}) {
    return BoxDecoration(
      ...
      boxShadow: [
        BoxShadow(
          color:
              isLight ? Colors.black.withAlpha(26) : Colors.black.withAlpha(77),
